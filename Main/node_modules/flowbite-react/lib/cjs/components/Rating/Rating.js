...
const RatingComponent = ({ children, className, size = 'sm', theme: customTheme = {}, ...props }) => {
    const theme = (0, merge_deep_1.mergeDeep)((0, __1.useTheme)().theme.rating, customTheme);
    return ((0, jsx_runtime_1.jsx)(RatingContext_1.RatingContext.Provider, { value: { size }, children: (0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)(theme.root.base, className), ...props, children: children }) }));
};
