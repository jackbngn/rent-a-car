...
const SidebarCTA = ({ children, color = 'info', className, theme: customTheme = {}, ...props }) => {
    ...
    const theme = (0, merge_deep_1.mergeDeep)((0, __1.useTheme)().theme.sidebar.cta, customTheme);
    return ((0, jsx_runtime_1.jsx)("div", { "data-testid": "sidebar-cta", hidden: isCollapsed, className: (0, classnames_1.default)(theme.base, theme.color[color], className), ...props, children: children }));
};
