...
const TimelineContent = ({ children, className, theme: customTheme = {}, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { "data-testid": "timeline-content", className: (0, classnames_1.default)(horizontal && theme.root.base, className), ...props, children: children }));
};
