...
const TableComponent = ({ children, className, hoverable, striped, theme: customTheme = {}, ...props }) => {
    const theme = (0, merge_deep_1.mergeDeep)((0, __1.useTheme)().theme.table, customTheme);
    return ((0, jsx_runtime_1.jsx)("div", { "data-testid": "table-element", className: (0, classnames_1.default)(theme.root.wrapper), children: (0, jsx_runtime_1.jsxs)(TableContext_1.TableContext.Provider, { value: { striped, hoverable }, children: [(0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)(theme.root.shadow, className) }), (0, jsx_runtime_1.jsx)("table", { className: (0, classnames_1.default)(theme.root.base, className), ...props, children: children })] }) }));
};
