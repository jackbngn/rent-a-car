...
const NavbarCollapse = ({ children, className, theme: customTheme = {}, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { "data-testid": "flowbite-navbar-collapse", className: (0, classnames_1.default)(theme.base, theme.hidden[!isOpen ? 'on' : 'off'], className), ...props, children: (0, jsx_runtime_1.jsx)("ul", { className: theme.list, children: children }) }));
};
