	...
	<div>
		...
		<div className="flex justify-center">
			<div className="container grid lg:grid-cols-3 gap-4">
				...
				<div className=' bg-white border-2 border-slate-300 rounded shadow-md mr-2'>
				...
				<div className='bg-white border-2 border-slate-300 rounded shadow-md mr-2'>
					<div className='ml-4 mt-3'>
						...
						<hr className='h-px my-2 mr-4 bg-gray-200 border-0 dark:bg-gray-700'></hr>
						<div className='cost mb-4 font-bold'>
							<div className='mt-3 ml-2 text-lg'>$38.19 USD Per Day</div>
				...
				<div className='bg-white border-2 border-slate-300 rounded shadow-md mr-2'>
					...
					<div className='ml-10 mt-16'>
						<img className='object-fill h-48' src='https://www.pngall.com/wp-content/uploads/11/Red-Tesla-Model-S.png'></img>
						...
						<hr className='h-px my-2 mr-4 bg-gray-200 border-0 dark:bg-gray-700'></hr>
						<div className='cost mb-4 font-bold'>
							<div className='mt-3 ml-2 text-lg'>$65.35 USD Per Day</div>
							<div className='button-container'>
								<button className='bg-yellow-300 hover:bg-yellow-400 border-none font-bold text-black py-2 px-10 rounded'>
										Select
								</button>
				...
				<div className='bg-white border-2 border-slate-300 rounded shadow-md mr-2'>
					<div className='ml-4'>
						<img className='object-fill  h-72' src='https://platform.cstatic-images.com/xlarge/in/v2/stock_photos/e0dd7d55-88a8-4f2e-a8af-5a87b75938fb/a8f55f30-3dd4-4712-8662-026a527ec97d.png'></img>
				...
				<div className='bg-white border-2 border-slate-300 rounded shadow-md mr-2'>
					<div className='ml-4'>
						<img className='object-fill h-72 ' src='https://media.chromedata.com/MediaGallery/media/MzE2NzQwXk1lZGlhIEdhbGxlcnk/Hl4pVbupCUJCCMNGgooqvzrTgg-qmStA8M5socufRDNdmAtg2R2xWjqweAgYIgX__UooCdcfEWmSFZBfVk7gJFdMrPqfg2cUHMXjG2qQu_aUJlgCNnHZb3yworEeHQVhcFl7x3MC5Vx6hWjN6F9ddElCbxoFEWMh_ZiiaCVp7NveWq0zii8Jww/2017TOV110003_1280_01.png'></img>
						...
						<hr className='h-px my-2 mr-4 bg-gray-200 border-0 dark:bg-gray-700'></hr>
						<div className='cost mb-4 font-bold'>
							<div className='mt-3 ml-2 text-lg'>$59.76 USD Per Day</div>
				...
				<div className='bg-white border-2 border-slate-300 rounded shadow-md mr-2'>
					<div className='ml-4'>
						...
						<hr className='h-px my-2 mr-4 bg-gray-200 border-0 dark:bg-gray-700'></hr>
						<div className='cost mb-4 font-bold'>
							<div className='mt-3 ml-2 text-lg'>$63.26 USD Per Day</div>
				...
				<div className='bg-white border-2 border-slate-300 rounded shadow-md mr-2 mb-4'>
					<div className='vehicleBadge'>Electric Vehicle</div>
						<div className='ml-4'>
